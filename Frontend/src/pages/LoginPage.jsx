...
function LoginPage() {
	const [formData, setFormData] = useState({ email: "", password: "" }); {/*take note */ }
	const { login, isLoggingIn } = useAuthStore(); {/*take note */ }

	const handleSubmit = (e) => {
		e.preventDefault();
		login(formData); {/*take note */ }
	}
					...
					<div className="md:w-1/2 p-8 flex items-center justify-center md:border-r border-slate-600/30">
						<div className="w-full max-w-md">
							...
							<form onSubmit={handleSubmit} className="space-y-6">
								...
								</div> {/* Take note, get a breakdown of this */}
